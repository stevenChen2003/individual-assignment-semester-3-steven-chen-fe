    ...
    <Modal.Body>
      <Form onSubmit={handleSubmit}>
        <Form.Group>
          ...
          <Form.Control type="text" placeholder="Enter cinema name" name="name" value={cinema.name} onChange={handleChange} />
        </Form.Group>
        <Form.Group>
          <Form.Label>Location</Form.Label>
          <Form.Control type="text" placeholder="Enter location" name="location" value={cinema.location} onChange={handleChange} />
        </Form.Group>
        <Form.Group>
          <Form.Label>Number of Halls</Form.Label>
          <Form.Control type="number" placeholder="Enter number of halls" name="numHalls" value={cinema.numHalls} onChange={handleChange} />
        </Form.Group>
